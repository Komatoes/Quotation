...
<html
  ...
  <head>
    ...
    <title>Demo: Navbar - UI elements | Vuexy - Bootstrap Dashboard PRO</title>
                            ...
                            <div class="row row-bordered">
                                ...
                                <ul class="nav flex-column">
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"
                                      ><i class="icon-base ti tabler-mail icon-sm me-1"></i> Email</a
                                    >
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"
                                      ><i class="icon-base ti tabler-messages icon-sm me-1"></i> Chat</a
                                    >
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"
                                      ><i class="icon-base ti tabler-checklist icon-sm me-1"></i> ToDos</a
                                    >
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link mega-dropdown-link" href="javascript:void(0)"
                                      ><i class="icon-base ti tabler-calendar icon-sm me-1"></i> Calender</a
                                    >
                                  </li>
                                  <li class="nav-item">
                                    <a
                                      ...
                                      href="javascript:void(0)"
                                      tabindex="-1"
                                      ><i class="icon-base ti tabler-ban icon-sm me-1"></i> Disabled</a
                                    >
                                  </li>
                                </ul>
                              </div>
                              ...
                              <div class="col-sm-6 col-lg p-4">
                                ...
                                <div class="list-group">
                                  <a
                                    href="javascript:void(0)"
                                    class="list-group-item list-group-item-action mega-dropdown-link"
                    ...
                    <div class="collapse navbar-collapse" id="navbar-ex-15">
                      <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item mega-dropdown">
                          <a
                            href="javascript:void(0);"
                            class="nav-link dropdown-toggle navbar-ex-15-mega-dropdown mega-dropdown"
                            aria-expanded="false"
                            data-bs-toggle="mega-dropdown"
                            data-trigger="hover"
                            >Mega</a
                      ...
                      <ul class="navbar-nav ms-lg-auto">
                        <li class="nav-item">
                          <a class="nav-link" href="javascript:void(0);"
                            ><i class="icon-base navbar-icon ti tabler-user icon-xs me-1"></i> Profile</a
                          >
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="javascript:void(0);"
                            ><i class="icon-base navbar-icon ti tabler-settings icon-xs me-1"></i> Settings</a
                          >
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="javascript:void(0);"
                            ><i class="icon-base navbar-icon ti tabler-lock-open icon-xs me-1"></i> Logout</a
                          >
                        </li>
                      </ul>
                    </div>
