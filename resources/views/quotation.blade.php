            ...
            @if (empty($readonly))
                <div class="row mt-3 g-2">
                    <div class="col-12 col-md-auto">
                        ...
                        <button type="button" class="btn btn-outline-secondary w-100" id="generateLinkBtn">
                            <i class="bi bi-link-45deg"></i> Generate & Copy Public Link
                        </button>
                    </div>
                    <button type="button" class="btn btn-success" id="approveBtn" data-quot="{{ $quotation->id }}" @if(!$quotation->customer_approved) disabled @endif>
                        Approve
                    </button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (submitBtn && commentInput) {
            submitBtn.addEventListener('click', async function() {
                ...
                if (!comment) {
                    Swal.fire('Empty Comment', 'Please write a comment before submitting.', 'warning');
                    return;
                }
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (generateLinkBtn) {
                    generateLinkBtn.addEventListener('click', async function() {
                        ...
                        generateLinkBtn.innerHTML = '<i class="bi bi-link-45deg"></i> Generate & Copy Public Link';
                    });
                }
            });
        </script>
