...
<head>
    ...
    <title>Verify OTP - Quotation System</title>
            ...
            <div class="face face-front">
                <div class="content">
                    ...
                    <form method="POST" action="{{ route('verify.otp') }}">
                        ...
                        <div class="field-wrapper">
                            ...
                            <div class="expiry-notice">
                                <i class="fa-solid fa-clock"></i> Expires in 15 minutes
                            </div>
                        </div>
                    ...
                    <div class="links" style="margin-top: 20px;">
                        <a href="{{ route('forgot.password') }}" class="link-item">← Request New OTP</a>
                    </div>
                </div>
            </div>
