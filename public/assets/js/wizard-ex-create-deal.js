...
(function () {
  ...
  if (typeof wizardCreateDeal !== undefined && wizardCreateDeal !== null) {
    ...
    // Wizard steps
    const wizardCreateDealFormStep1 = wizardCreateDealForm.querySelector('#New-Products');
    const wizardCreateDealFormStep2 = wizardCreateDealForm.querySelector('#Main-Info');
    const wizardCreateDealFormStep3 = wizardCreateDealForm.querySelector('#deal-usage');
    const wizardCreateDealFormStep4 = wizardCreateDealForm.querySelector('#booking');
    const wizardCreateDealFormStep5 = wizardCreateDealForm.querySelector('#review-complete');
    ...
    // Deal Usage
    const FormValidation5 = FormValidation.formValidation(wizardCreateDealFormStep5, {
      fields: {
        // * Validate the fields here based on your requirements
      },
      plugins: {
